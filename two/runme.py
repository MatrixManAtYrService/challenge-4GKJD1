...
if __name__ == "__main__":
    ...
    last = None
    count = 0
    for string in palendromes:
        if not is_a_palendrome(string):
            count += 1
            last = string

    print(f"{count} strings found that were not palendromes")
    if last:
        print(f"most recently: {last}")
